...
import 'package:demoparty_assistant/data/services/voting_service.dart';
import 'package:demoparty_assistant/utils/widgets/drawer/drawer.dart';
import 'package:demoparty_assistant/utils/widgets/cards/voting_result_card.dart';
...
class _VotingResultsScreenState extends State<VotingResultsScreen> {
  ...
  Future<void> _fetchCategories({bool forceRefresh = false}) async {
    ...
    try {
      final fetchedCategories = await _votingService.fetchCategories(forceRefresh: forceRefresh);
  ...
  Future<void> _fetchVotingEntries(String url, {bool forceRefresh = false}) async {
    ...
    try {
      final fetchedEntries = await _votingService.fetchVotingData(url, forceRefresh: forceRefresh);
                ...
                child: Padding(
                  ...
                  child: DropdownButton<String>(
                    ...
                    onChanged: (value) {
                      ...
                      _fetchVotingEntries(selectedCategory.url);
                    },
                  ),
                ),
              ),
